...
5. component inputs: lifted up + immediatelly available in setup and providers,
...
`expose` is the public interface of `setup()` for refs. Components return it with `template`; directives return it from `setup`.
